...
esp_err_t context_build_system_prompt(char *buf, size_t size)
{
    ...
    off += snprintf(buf + off, size - off,
        ...
        "- set_led_color: Set the WS2812B RGB LED on GPIO8 using r/g/b values and optional brightness.\n"
        "- led_off: Turn off the WS2812B RGB LED on GPIO8.\n\n"
        "- breathing_led_on: Enable breathing mode for the WS2812B RGB LED using optional r/g/b values, max brightness, and an optional full-cycle period in ms or seconds.\n"
