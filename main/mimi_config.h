...
/* WS2812B LED */
#define MIMI_WS2812_GPIO             48
#define MIMI_WS2812_LED_COUNT        1
#define MIMI_WS2812_RMT_RES_HZ       (10 * 1000 * 1000)
#define MIMI_WS2812_BOOT_RED         255
#define MIMI_WS2812_BOOT_GREEN       0
#define MIMI_WS2812_BOOT_BLUE        0
#define MIMI_WS2812_BOOT_BRIGHTNESS  128
#define MIMI_WS2812_BREATH_STEP_MS   25
#define MIMI_WS2812_BREATH_STEP      5
#define MIMI_WS2812_BREATH_PERIOD_MS 5000
#define MIMI_WS2812_BREATH_FRAME_MS  20
